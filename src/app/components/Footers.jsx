...
export function Footer() {
  return (
<footer className="relative w-full pb-20 pt-60 bg-gradient-to-b from-gray-900/5 to-gray-900/50">
  <div className="w-full px-8 mx-auto max-w-7xl">
    <div className="grid justify-between grid-cols-1 gap-4 md:grid-cols-2">
      ...
      <div className="ml-20 grid justify-between grid-cols-2 gap-4">
        <ul>
          ...
          <li>
            <a href="/about" className="block text-slate-600 py-1 hover:text-slate-500 focus:text-slate-500 text-sm">
              About
            </a>
          </li>
          <li>
            <a href="/contacto" className="block text-slate-600 py-1 hover:text-slate-500 focus:text-slate-500 text-sm">
              Contacto
            </a>
          </li>
        </ul>
    ...
    <div className="flex flex-col items-center justify-center w-full py-4 mt-12 border-t border-slate-200 md:flex-row md:justify-between">
      ...
      <div className="flex gap-4 text-slate-600 sm:justify-center">
        ...
        <a href="https://www.instagram.com/londolabs/" target="_blank" className="block transition-opacity text-inherit hover:opacity-80">
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path fillRule="evenodd"
